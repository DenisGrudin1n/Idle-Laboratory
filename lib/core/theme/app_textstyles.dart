...
class AppTextStyles {
  ...
  TextStyle get helperText => TextStyle(color: _color.primaryText, fontSize: 10.sp, fontWeight: FontWeight.w400);

  TextStyle get successText => TextStyle(color: _color.green, fontSize: 11.sp, fontWeight: FontWeight.w500);

  TextStyle get energyValue => TextStyle(color: _color.titleText, fontSize: 20.sp, fontWeight: FontWeight.bold);

  TextStyle get bodyLabel => TextStyle(color: _color.primaryText, fontSize: 12.sp, fontWeight: FontWeight.w500);

  TextStyle get buttonLabel => TextStyle(color: _color.primaryText, fontSize: 12.sp, fontWeight: FontWeight.bold);
  ...
  TextStyle cellName({required bool isLocked}) =>
      TextStyle(color: isLocked ? _color.primaryText : _color.titleText, fontSize: 11.sp, fontWeight: FontWeight.w600);

  TextStyle get compactValue => TextStyle(color: _color.primaryText, fontSize: 9.sp, fontWeight: FontWeight.w400);

  TextStyle get compactAccentValue => TextStyle(color: _color.green, fontSize: 9.sp, fontWeight: FontWeight.w500);

  TextStyle get compactSupporting => TextStyle(color: _color.primaryText, fontSize: 9.sp, fontWeight: FontWeight.w500);
  ...
  TextStyle get productionAccelerationLevel =>
      TextStyle(color: _color.green, fontSize: 9.sp, fontWeight: FontWeight.w600);
